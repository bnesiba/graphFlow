...
namespace GraphFlow.persistence.models
{
    public class GraphThread<T>
    {
        ...
        public List<StoredGraphExecutionData<T>> Runs { get; init; }
        ...
        private int runsort(GraphExecutionData<T> run1, GraphExecutionData<T> run2)
        {
        ...
        //}
        public GraphThread(Guid threadId, List<StoredGraphExecutionData<T>> runs)
        {
